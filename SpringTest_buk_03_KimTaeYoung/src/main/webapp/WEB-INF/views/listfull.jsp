		...
		<div class="filter">
			<form action="" method="get">
				<label for="date">날짜 선택:</label> <input type="date" id="date"
					name="date"> <label for="resourceId">자원 선택:</label> <select
					id="resourceId" name="resourceId">
					<option value="0">자원을 선택하세요</option>
					<c:forEach var="" items="">
						<option value=""></option>
					</c:forEach>
				</select> <input type="submit" value="필터링"> <a href="#"
					class="main-button">전체보기</a> <a href="${root}/" class="main-button">메인으로</a>
			</form>
		</div>
